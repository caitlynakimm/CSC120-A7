...
_**YES**____ 1 pt: The `House` class includes the requested attributes
...
_**YES**____ 1 pt: The `Cafe` class uses the `restock(...)` method to avoid running out of inventory.
